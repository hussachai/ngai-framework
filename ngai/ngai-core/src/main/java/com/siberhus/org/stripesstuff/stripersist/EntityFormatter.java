...
/**
 * <p>EntityFormatter returns an entity's primary key as a string so Stripes
 * can insert it into web pages.</p>
 * 
 * <p>{@link EntityTypeConverter} performs the reverse operation.</p>
 * 
 * @author Aaron Porter
...
public class EntityFormatter implements Formatter<Object>
{
	 ...
	 * 
	 * @param entity the object being formatted
	...
	public String format(Object entity)
	{
		...
		Formatter idFormatter = StripesFilter.getConfiguration().getFormatterFactory().getFormatter(id.getClass(), locale, null, null);
